...
# Exercícios de Lógica de Programação e algorítmos

## Descrição
Resolução dos exercícios de Lógica de Programação e Algoritmos da [lista de exercícios da Wiki da Python Brasil](https://wiki.python.org.br/ListaDeExercicios), com a linguagem Python.
## Conteúdo
